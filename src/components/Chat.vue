...
<template>
    <div class="flex flex-col h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <form class="bg-white dark:bg-gray-700 p-4 flex items-center">
            <input type="text"
                class="flex-1 rounded-full border-gray-100 border-2 px-4 py-2 mr-2 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-900 dark:border-gray-500 dark:text-gray-100"
            ...
            <button @click="handleModo" class="inline-flex items-center px-4 py-2 border border-transparent rounded-full font-semibold text-white bg-indigo-500 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                {{
                    modo === 'dark' ? '🌞' : '🌙'
                }}
            </button>
